...
public class VacancyControllerTest {
    ...
    @Test
    public void whenFindVacancyByIdThenGetEditPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        ...
        var actualVacancyToEdit = model.getAttribute("vacancy");
        var actualCities = model.getAttribute("cities");

        assertThat(view).isEqualTo("vacancies/one");
        assertThat(actualVacancyToEdit).isEqualTo(vacancy);
        assertThat(actualCities).isEqualTo(expectedCities);
    }

    @Test
    public void whenRequestVacancyByIncorrectIdThenGetErrorPage() {
    ...
    @Test
    public void whenUpdateVacancyThenGetVacanciesPage() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
    ...
    @Test
    public void whenUpdateIncorrectVacancyThenGetErrorPage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
    ...
    @Test
    public void whenSomeExceptionThrownThenGetErrorPage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    @Test
    public void whenDeleteVacancyByIdThenGetVacanciesPage() {
    ...
    @Test
    public void whenDeleteVacancyByIncorrectIdThenGetErrorPage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
